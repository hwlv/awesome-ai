...
- 真的能跑的脚本或项目放 `examples/`
- 不继续沿用 `ai-doc/1-xxx/README.md + task.md` 这种混放方式

## 推荐阅读顺序

1. [Web 开发者转 AI 学习路线](/learning/web-developer-to-ai-roadmap)
2. [阶段 1：Python 与数学基础](/learning/python-math-basics)
3. [阶段 2：经典机器学习](/learning/classical-ml)
4. [阶段 3：深度学习核心](/learning/deep-learning-core)
5. [阶段 4：AI + Web 产品化](/learning/ai-web-product)
